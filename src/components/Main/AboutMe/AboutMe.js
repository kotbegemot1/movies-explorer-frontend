  ...
  return (
    <section className="about-me">
      <div className="about-me__container">
        ...
        <img className="about-me__image" alt='student foto' src={avatar} />
        ...
        <a href="https://github.com/kotbegemot1" className="about-me__link link" rel="noreferrer" target="_blank">Github</a>
      </div>
    </section>
  )
}